package co.com.gsdd.course.app.config;
...
import co.com.gsdd.course.app.CourseApplication;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Course SQL REST", "REST con Spring-Boot & SQLite", "0.0.1.SNAPSHOT", null, getContact(),
